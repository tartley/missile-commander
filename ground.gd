...
const annotated_polar_array := [
    ...
    [PI / 2 -  4 * seg_ang, RADIUS, "gap", "hill2"],
    [PI / 2 -  2 * seg_ang, RADIUS + HILL_HEIGHT, "gap", "hill2"],
    ...
    [PI / 2 + 14 * seg_ang, RADIUS, "gap"],
    [PI / 2 + 16 * seg_ang, RADIUS, "city"],
    [PI / 2 + 20 * seg_ang, RADIUS, "gap", "hill3"],
    [PI / 2 + 22 * seg_ang, RADIUS + HILL_HEIGHT, "gap", "hill3"],
    [PI / 2 + 24 * seg_ang, RADIUS + HILL_HEIGHT, "base"],
    [PI / 2 + 26 * seg_ang, RADIUS + HILL_HEIGHT, "gap", "hill3"],
    [PI / 2 + 28 * seg_ang, RADIUS, "gap", "hill3"],
    [PI / 2 + 36 * seg_ang, RADIUS],
    [PI / 2 + 44 * seg_ang, RADIUS],
    [PI / 2 + 44 * seg_ang, 0],
]
